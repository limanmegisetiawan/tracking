   ...
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            <h4 class="modal-title">Tambah Group Kendaraan</h4>
         ...
         <div class="modal-body">
            <form id="geofencesave" method="post" action="<?php echo base_url(); ?>vehicle/addgroup">
               <div class="card-body">
                  ...
                  <div class="form-group row">
                     <label for="Cateogry" class="col-sm-4 col-form-label">Deskripsi</label>
                     <div class="form-group col-sm-8">
                        <input type="text" class="form-control" name="gr_desc" id="gr_desc" required="true" placeholder="Enter Deskripsi">
                     </div>
                  </div>
               </div>
         </div>
