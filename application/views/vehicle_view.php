                    ...
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                <b>Geofence</b>
                                <a class="float-right"><?= count($vechicle_geofence); ?></a>
                            </li>
                            <li class="list-group-item">
                                <b>Notifications</b>
                                <a class="float-right"><?= count($geofence_events); ?></a>
                            </li>
                        </ul>
                ...
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a class="nav-link active" href="#basicinfo" data-toggle="tab">Basic Info</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#vechicle_geofence" data-toggle="tab">Geofence</a>
                            </li>
                        </ul>
                    </div>
                    <!-- /.card-header -->
                        ...
                        <div class="tab-content">
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="icon" href="<?php echo base_url(); ?>geofence">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                        </tr>
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="icon" href="<?php echo base_url(); ?>incomexpense">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                        </tr>
